...
const { getAllPost, createPost, getPostById, deletePostById, updatePostById, getAllSchedule, getScheduleById, createSchedule, deleteScheduleById, updateScheduleById } = require("../controllers/shortcutController");
